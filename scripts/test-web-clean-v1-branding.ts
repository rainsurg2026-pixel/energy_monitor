...
const webV3 = readFileSync(new URL("../src/web/WebV3App.tsx", import.meta.url), "utf8");
const settings = readFileSync(new URL("../src/web/WebV3SettingsApp.tsx", import.meta.url), "utf8");

for (const source of [clean, exportsSource, webV3, settings]) {
...
console.log("web-clean-v1 branding: login, shell, settings, legacy web, report titles, and filenames use the approved product name");
