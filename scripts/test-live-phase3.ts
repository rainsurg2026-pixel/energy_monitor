...
const authService = new AuthService(authRepository, { passwordHasher, dummyPasswordHash: await passwordHasher.hash(`dummy-${testId}`), sessionSecret: config.sessionSecret });
