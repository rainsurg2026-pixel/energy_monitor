...
.executive-capacity-trends{display:grid;grid-template-columns:1fr;gap:8px;margin-top:10px}.executive-capacity-trends .block{margin:0;padding:7px 10px}.executive-capacity-trends h3{font-size:16px;margin-bottom:1px}.executive-capacity-trends .note{font-size:10px;margin-top:1px}.executive-capacity-trends svg{height:186px!important}.executive-capacity-trends .trend-legend{justify-content:center;margin-top:-2px}.executive-capacity-trends .trend-legend span{font-size:11px}
...
export function buildCurrentFacilityPdfBody(data: ReportData, selectedSections?: readonly ReportSectionId[]): string {
  ...
  const executive = currentExecutiveDashboardPage(data) + currentExecutiveTrendPages(data) + currentExecutiveCapacityPage(data);
