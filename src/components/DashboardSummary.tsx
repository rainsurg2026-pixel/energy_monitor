...
import { formatFixedNumber, formatGWh, formatNumber2 } from "../utils/numberFormatBridge";
import { 
  TrendingUp, 
  Zap, 
  Thermometer, 
                  ...
                  <tbody className="divide-y divide-slate-850">
                    ...
                    <tr className="text-slate-400">
                      ...
                      {calcs.airFields.map(field => {
                        ...
                        return <td key={field} className="py-3 px-3 text-right font-mono">{formatGWh(value)}</td>;
                      })}
