...
export default function WebReportPreview({ lang, siteId, siteName, logs, month, rackCapacityHistory, rackUnitCapacity, calculationLogs, upsGroupHistory, sections, onRefresh }: {
  lang: "th" | "en";
  siteId: number | null;
  siteName: string;
