...
export default function WebEntryWorkspace({ lang, siteName, siteCode, months, month, draft, busy, allowedStartMonth, allowedEndMonth, onSave, onSelectMonth, onOpenReports, onNotice, onDirtyChange, onRegisterActions }: {
  lang: "th" | "en";
  siteName: string;
  siteCode: string;
  months: string[];
