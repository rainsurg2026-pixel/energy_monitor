...
function RackAvailabilityChart({ sites }: { sites: RackSiteTotal[] }) {
  ...
  return <section className="rounded-2xl border border-slate-800 bg-slate-900 p-5" aria-label="Available Racks by Site">
...
function BestLocations({ rows }: { rows: RackRow[] }) {
  ...
  return <section className="rounded-2xl border border-slate-800 bg-slate-900 p-5" aria-label="Best Locations for New Rack Installation">
...
function RackZoneTable({ rows }: { rows: RackRow[] }) {
  ...
  return <section className="rounded-2xl border border-slate-800 bg-slate-900 p-5" aria-label="Rack Availability by Zone">
