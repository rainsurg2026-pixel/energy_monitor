...
export function addInteractiveDashboard(workbook: any, prefix: string, siteName: string, metrics: ExcelDashboardMetric[], options: { dashboardSheetName?: string; dataSheetName?: string; includeDataSheet?: boolean; exportedBy?: string | null; exportedAt?: string } = {}): ExcelDashboardPlan {
  ...
  dashboard.getCell("A4").font = { name: "Aptos", size: 10, bold: true, color: { argb: TEXT } };
  dashboard.mergeCells("B4:E4");
  dashboard.getCell("B4").value = options.exportedBy ?? "";
  dashboard.getCell("B4").font = { name: "Aptos", size: 10, color: { argb: TEXT } };
  dashboard.getCell("G4").value = "Generated At";
  dashboard.getCell("G4").font = { name: "Aptos", size: 10, bold: true, color: { argb: TEXT } };
  dashboard.mergeCells("H4:N4");
  dashboard.getCell("H4").value = options.exportedAt ?? "";
...
export function addCurrentFacilityDashboard(workbook: any, siteName: string, metrics: ExcelDashboardMetric[], options: CurrentFacilityDashboardOptions): ExcelDashboardPlan {
  ...
  sheet.getCell("A1").value = "Current Facility Dashboard";
  ...
  sheet.getCell("A2").value = siteName + " - native Excel dashboard - change Reporting Month to recalculate";
  ...
  for (const address of ["A3", "D3", "G3", "J3"]) sheet.getCell(address).font = { name: "Aptos", size: 10, bold: true, color: { argb: TEXT } };
  ...
  sheet.getCell("H3").value = options.exportedBy ?? "";
  sheet.getCell("H3").font = { name: "Aptos", size: 10, color: { argb: TEXT } };
  sheet.mergeCells("K3:N3");
  sheet.getCell("K3").value = options.exportedAt;
