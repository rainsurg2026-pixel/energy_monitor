...
export function addCurrentFacilityDashboard(workbook: any, siteName: string, metrics: ExcelDashboardMetric[], options: CurrentFacilityDashboardOptions): ExcelDashboardPlan {
  ...
  sheet.getCell("A1").font = { name: "Aptos Display", size: 20, bold: true, color: { argb: NAVY } };
  ...
  sheet.getCell("E3").fill = { type: "pattern", pattern: "solid", fgColor: { argb: WHITE } };
  ...
  sheet.getCell("H3").fill = { type: "pattern", pattern: "solid", fgColor: { argb: WHITE } };
  ...
  sheet.getCell("K3").fill = { type: "pattern", pattern: "solid", fgColor: { argb: WHITE } };
